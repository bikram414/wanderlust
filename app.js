...
// SQLite connection and sync with auto-seeding
sequelize.authenticate()
  ...
  .then(() => {
    ...
    // Auto-seed if no listings exist
    return Listing.count();
  })
  .then(count => {
    if (count === 0) {
      console.log('No listings found, seeding sample data...');
...
// Updated passport configuration for SQLite
...
app.listen(8080, () => {
  console.log("Server is running fine with SQLite");
});